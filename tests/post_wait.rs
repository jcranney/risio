use risio::{Accessor, LocalImage, ShmImage, error::Error};

#[test]
fn post_wait_local() -> Result<(), Error> {
    let mut image: LocalImage<f64> = LocalImage::create_new("noise", &[100, 100])?;
    let posts = 100;
